...
significant variables. Since our objective is the prediction of *gross* revenue per movie, we choose as starting point the complete model, in contrast to starting form the null which would result in a simpler model, albeit loss in predictability.
```{r}
...
remove it from our model. **PREGUNTAR SI TIENE SENTIDO QUEDARSE CON YEARCAT Y/O SUS INTERACCIONES**
...
# outreg(list("LM with Actor1fl"=lm.actor1,
#             "LM with Actor2fl"=lm.actor2,
#             "LM with Castfl"=lm.cast),
#        tight = FALSE)  #latex table
```
